                    ...
                    <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
                        ...
                        <div className="hidden lg:flex lg:items-center lg:justify-center">
                            <div className="w-full max-w-lg xl:max-w-2xl">
                                <img
                                    src="/Images/Shopkeeper/register.png"
                            ...
                            <div className="w-full max-w-md lg:max-w-lg">
                                ...
                                <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-5">
                                    ...
                                    <div>
                                        ...
                                        <div className="relative">
                                            ...
                                            <button
                                                ...
                                                className="absolute right-3 sm:right-4 top-1/2 -translate-y-1/2 text-gray-500 hover:text-[#6F9C3D] focus:outline-none focus:text-[#6F9C3D] transition-colors duration-200"
                                    ...
                                    <div className="flex justify-start items-center gap-2">
                                        <input
                                            ...
                                            className="w-4 h-4 text-[#6F9C3D] bg-white border-gray-300 rounded transition-colors duration-200
                                        ...
                                        >
                                            ...
                                            <Link 
                                                ...
                                                className="text-[#6F9C3D] hover:text-[#5d8a32] hover:underline transition-colors duration-200 focus:outline-none focus:underline"
                                            >
                                ...
                                <div className="flex items-center justify-center gap-3 sm:gap-4 my-6 sm:my-8">
                                    ...
                                    <Link 
                                        ...
                                        className="text-sm sm:text-base lg:text-lg font-medium text-[#6F9C3D] hover:underline whitespace-nowrap transition-colors duration-200 focus:outline-none focus:underline">
                                        Already Registered?
                                    </Link>
                                    <div className="flex-1 border-t-2 border-[#6F9C3D]"></div>
                                </div>
