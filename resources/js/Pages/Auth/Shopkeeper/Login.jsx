...
export default function Login() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post("/api/v1/shopkeeper/login", {
                ...formData,
                remember: rememberMe,
            });
                            ...
                            <div className="w-full max-w-md lg:max-w-lg">
                                ...
                                <form onSubmit={handleSubmit} className="space-y-4 sm:space-y-5">
                                    ...
                                    <div>
                                        ...
                                        <div className="relative">
                                            ...
                                            <button
                                                ...
                                                disabled={processing}
                                                className="absolute right-3 sm:right-4 top-1/2 -translate-y-1/2 text-gray-500 hover:text-[#6F9C3D] focus:outline-none focus:text-[#6F9C3D] transition-colors duration-200 disabled:opacity-50"
                                    ...
                                    <button
                                        type="submit"
                                        disabled={processing}
                                        className="w-full bg-[#6F9C3D] text-white py-3 sm:py-4 rounded-lg font-medium text-sm sm:text-base
                                ...
                                <div className="text-center">
                                    <p className="text-sm sm:text-base text-gray-600">
                                        ...
                                        <Link
                                            ...
                                            className="text-[#6F9C3D] hover:text-[#5d8a32] hover:underline font-medium transition-colors duration-200 focus:outline-none focus:underline"
                                        >
                                            Sign up
                                        </Link>
                                    </p>
