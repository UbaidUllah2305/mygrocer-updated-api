// resources/js/Components/OrderDispatchedModal.jsx
import React from 'react';

const OrderDispatchedModal = ({ order, selectedItems = [], onClose, onMarkAsDelivered }) => {
    ...
    <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-2 sm:p-4 z-50">
      <div className="relative bg-white rounded-xl w-full max-w-[95vw] lg:max-w-[1131px] max-h-[95vh] overflow-y-auto shadow-xl">
        ...
        <div className="p-4 sm:p-6 lg:p-7">
            ...
            <div className="flex flex-col sm:flex-row gap-4 sm:gap-8 lg:gap-12 flex-1">
              ...
              <div className="flex-1">
                ...
                <div className="space-y-0.5 text-sm sm:text-base lg:text-xl font-medium text-[#3a3e47]" style={{ fontFamily: "'Inter', sans-serif" }}>
                  ...
                  <p>Status : <span className="text-blue-500">Dispatched</span></p>
                </div>
              </div>
          ...
          {/* <div className="bg-[rgba(59,130,246,0.2)] border border-blue-500 rounded-xl py-3 sm:py-4 lg:py-[15px] px-4 sm:px-6 lg:px-[57px] mb-4 lg:mb-6">
