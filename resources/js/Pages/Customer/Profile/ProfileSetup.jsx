...
export default function ProfileSetup({ auth }) {
  ...
  const countries = ["Saudi Arabia", "United Arab Emirates", "Qatar", "Kuwait"];
        ...
        <div className="flex items-center justify-center min-h-[60vh]">
          <div className="text-center">
            ...
            <div className="flex items-center justify-center space-x-2">
              <div className="w-3 h-3 bg-[#6F9C3D] rounded-full animate-bounce"></div>
              <div
    ...
    >
      ...
      <div className="mb-8 sm:mb-10">
        ...
        <p className="text-sm sm:text-base lg:text-lg text-gray-600">
          Add your details to setup your profile on MyGrocer.
        </p>
      </div>
