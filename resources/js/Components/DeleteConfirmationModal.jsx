...
const DeleteConfirmationModal = ({
  ...
  itemName,
  details,
  warningMessage = "This action cannot be undone. The item will be permanently removed.",
}) => {
  ...
  return (
    <>
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 pointer-events-none">
        <div
          className="relative w-full max-w-md rounded-2xl bg-white p-6 shadow-2xl border border-gray-200 pointer-events-auto animate-in zoom-in-95 duration-200"
        ...
        >
          ...
          <div className="text-center">
            ...
            <div id="delete-modal-description">
              ...
              {details && <p className="text-xs text-gray-500 mb-3">{details}</p>}
