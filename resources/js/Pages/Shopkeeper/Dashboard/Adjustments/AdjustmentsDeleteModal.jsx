// src/Components/Admin/AdjustmentsDeleteModal.jsx
import React from "react";
import { Trash2, X, AlertTriangle } from "lucide-react";

const AdjustmentsDeleteModal = ({ isOpen, item, onConfirm, onCancel }) => {
    ...
    <>
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 pointer-events-none">
        <div
          ...
          role="dialog"
          aria-modal="true"
          aria-labelledby="adjustment-delete-modal-title"
          aria-describedby="adjustment-delete-modal-description"
        >
          {/* Close Button */}
          <button
            type="button"
          ...
          <div className="text-center">
            <h3 
              id="adjustment-delete-modal-title"
              className="text-xl font-bold text-gray-900 mb-2"
            >
              Delete Adjustment?
            </h3>
            <div id="adjustment-delete-modal-description">
              ...
              <div className="bg-red-50 border border-red-200 rounded-lg p-3 mb-4">
                <p className="text-xs text-red-800 flex items-start gap-2">
                  ...
                  <span>
                    This action cannot be undone. The adjustment record will be permanently removed.
                  </span>
                </p>
              </div>
            </div>
...
export default AdjustmentsDeleteModal;