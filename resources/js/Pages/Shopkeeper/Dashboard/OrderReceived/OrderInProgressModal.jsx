...
const OrderInProgressModal = ({ order, selectedItems = [], onClose, onMarkAsReady }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50">
      {/* ✅ Fixed height — no vertical scroll on desktop */}
      <div className="relative bg-white rounded-xl w-full max-w-4xl max-h-[90vh] flex flex-col shadow-xl">
        ...
        <div className="flex-1 overflow-y-auto p-6">
            ...
            <div className="flex flex-col sm:flex-row gap-8 flex-1">
              <div className="flex-1">
                ...
                <div className="space-y-1 text-base font-medium text-[#3a3e47]">
                  ...
                  <p>Status: <span className="text-purple-500">Processing</span></p>
                </div>
              </div>
              <div className="flex-1">
          ...
          <div className="bg-[#fff0e6] border border-[#ff8829] rounded-xl py-2 px-4 mb-4 text-center font-medium text-[#3a3e47]">
          ...
          {/* ✅ TABLE STYLED LIKE TRENDS TABLE */}
...
export default OrderInProgressModal;