...
const OrderDeliveredModal = ({ order, selectedItems = [], onClose }) => {
  ...
  const totalAmount = order.totalAmount || "1,530";
  const riderName = order.riderName || "Muhammad Ali";
  const riderPhone = order.riderPhone || "0321-1234567";
    ...
    <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50">
      <div className="relative bg-white rounded-xl w-full max-w-4xl max-h-[90vh] flex flex-col shadow-xl">
        ...
        <div className="flex-1 overflow-y-auto p-6">
            ...
            <div className="flex flex-col sm:flex-row gap-8 flex-1">
              <div className="flex-1">
                ...
                <div className="space-y-1 text-base font-medium text-[#3a3e47]">
                  ...
                  <p>Status: <span className="text-green-500 font-semibold">Delivered ✓</span></p>
                </div>
              </div>
              <div className="flex-1">
          ...
          {/* Rider Info Banner */}
          <div className="bg-[#e8f5e0] border border-[#6f9c3d] rounded-xl py-3 px-4 mb-4">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2 text-[#3a3e47] font-medium">
              <span>Delivered by: <span className="font-semibold text-[#6f9c3d]">{riderName}</span></span>
              <span>Phone: <span className="font-semibold text-[#6f9c3d]">{riderPhone}</span></span>
            </div>
          </div>
          ...
          <div className="flex justify-end">
            <div className="text-right space-y-1">
              ...
              <p className="text-lg font-medium">Delivery Fee (Scheduled): Rs. {deliveryFee}</p>
        ...
        {/* Fixed Footer (Close Button Only) */}
