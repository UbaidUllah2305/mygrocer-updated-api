// resources/js/Components/OrderDeliveredModal.jsx
    ...
    <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-2 sm:p-4 z-50">
      <div className="relative bg-white rounded-xl w-full max-w-[95vw] lg:max-w-[1131px] max-h-[95vh] overflow-y-auto shadow-xl">
        ...
        <div className="p-4 sm:p-6 lg:p-7">
          ...
          {/* <div className="bg-[rgba(111,156,61,0.16)] border border-[#6f9c3d] rounded-xl py-3 sm:py-4 lg:py-[15px] px-4 sm:px-6 lg:px-[57px] mb-4 lg:mb-6">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
              <p className="text-[#3a3e47] font-medium text-sm sm:text-lg lg:text-xl" style={{ fontFamily: "'Inter', sans-serif" }}>
                <span className="text-[#6f9c3d]">Delivered by:</span> {riderName}
              </p>
              <p className="text-[#3a3e47] font-medium text-sm sm:text-lg lg:text-xl" style={{ fontFamily: "'Inter', sans-serif" }}>
                <span className="text-[#6f9c3d]">Phone:</span> {riderPhone}
              </p>
            </div>
          </div> */}
